...
const REFUND_SECTIONS = [
  {
    ...
    content: `تنطبق هذه السياسة على جميع المدفوعات التي تتم عبر ملاحم سرح. نحن نسعى دائماً لضمان رضا مستخدمينا، وندرك أن قد تنشأ حالات تستدعي إعادة النظر في المدفوعات.`,
  },
  {
  ...
  {
    title: 'التواصل',
    content: `للاستفسار أو تقديم طلب استرداد:\nعبر صفحة تواصل معنا داخل تطبيق ملاحم سرح، أو على الرقم +966 591 298 136.`,
  },
];
