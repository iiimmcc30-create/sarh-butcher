...
const TERMS = [
  {
    ...
    content: `باستخدامك ملاحم سرح فإنك توافق على الالتزام بهذه الشروط والأحكام. إن كنت لا توافق على أي بند منها، يُرجى عدم استخدام المنصة.`,
  },
  {
    title: 'شروط التسجيل',
  ...
  },
  {
    ...
    content: `المنصة وسيلة للتواصل بين الزبائن والملاحم فقط. لا تكون ملاحم سرح طرفاً في أي صفقة بين المستخدمين. أي نزاع تجاري هو مسؤولية الأطراف المتعاقدة مباشرة.`,
  },
  {
    title: 'الاشتراكات',
  ...
  },
  {
    ...
    content: `تُقدَّم المنصة "كما هي" دون ضمانات صريحة أو ضمنية. لا تتحمل ملاحم سرح أو مؤسسة ماد يونيت للتجارة مسؤولية أي خسائر تنتج عن استخدام المنصة أو المعاملات المُبرمة عبرها.`,
  },
  {
